import type { ImpactModuleId, ModuleSnapshot, Organization, Workspace } from "@/lib/impactos/types";
...
export const defaultDemoOrganizationSlug = "deep-blue-drawdown";

export function getDefaultDemoWorkspacePath() {
  return `/os/${defaultDemoOrganizationSlug}`;
}

const organization: Organization = {
  id: "org_demo_deep_blue_drawdown",
  slug: defaultDemoOrganizationSlug,
...
const placeholderModuleIds: ImpactModuleId[] = ["assistant", "workflows", "integrations", "admin"];
...
const deepBlueDrawdownFixture: DemoFixture = {
  organization,
  workspace,
  moduleSnapshots: [...oceanSnapshots, ...placeholderSnapshots],
};

export const demoFixtures: DemoFixture[] = [deepBlueDrawdownFixture];

export function getDemoFixtureBySlug(slug: string) {
  return demoFixtures.find((fixture) => fixture.organization.slug === slug);
}
